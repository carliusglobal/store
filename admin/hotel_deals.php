	<link rel="stylesheet" type="text/css" href="../restaurant/css/style.css?1522155548" />
	<link rel="stylesheet" type="text/css" href="../restaurant/rs-plugin/css/style.css" media="screen" />
	<link rel="stylesheet" type="text/css" href="../restaurant/rs-plugin/css/settings.css" media="screen" />
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="../restaurant/css/jquery.timepicker.css" />

	<script src="../restaurant/js/jquery-1.12.4.js"></script>
	<script src="../restaurant/js/jquery-ui.js"></script>
	<script src="../restaurant/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
	<script src="../restaurant/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
	<script src="../restaurant/js/jquery.validate.min.js"></script>
	<script src="../restaurant/js/jquery.inputmask.bundle.js"></script>
	<script src="../restaurant/js/inputmask.numeric.extensions.js"></script>
	<script src="../restaurant/js/phone.js"></script>
	<script src="../restaurant/js/jquery.timepicker.js"></script>
	<script src="../restaurant/js/pagination.js"></script>
	<script src="../restaurant/js/custom.js?1526046769"></script>
	<script src="https://maps.google.com/maps/api/js?key=YOUR API KEY HERE&libraries=places"></script>
	<script src="../restaurant/js/locationpicker.jquery.js"></script>
	<link rel="stylesheet" type="text/css" href="../restaurant/slick/slick.css">
	<link rel="stylesheet" type="text/css" href="../restaurant/slick/slick-theme.css">
	<script src="../restaurant/slick/slick.js" type="text/javascript" charset="utf-8"></script>
	<script>
...
$baseurl = $image_baseurl."/publicSite";
