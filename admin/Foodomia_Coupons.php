...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->	
	...
	<div class="row">
        ...
        <div class="pull-left"><h2 class="toast-title">Foodies Coupons</h2></div>
     <div class="pull-right">
	 
	 <a style="position: relative; top: 10px;" href='javascript:;' onClick='addtax()' class=' addfooomiacoupns btn btn-default'>Add Foodies Coupons</a></div>
